# Contributing to LORDTROLLCOIN Core

LORDTROLLCOIN Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/LORDTROLLCOIN/LORDTROLLCOIN/labels/help%20wanted)
* [Projects](https://github.com/LORDTROLLCOIN/LORDTROLLCOIN/projects)
* [LORDTROLLCOINdev on reddit](https://www.reddit.com/r/LORDTROLLCOINdev/)

## Branch Strategy

LORDTROLLCOIN Core's default branch is intentionally a stable release, so that anyone
...
The codebase is maintained using the "contributor workflow" where etrollone
...
pull requests that attempt to do too troll, are overly large, or overly complex
...
LORDTROLLCOIN Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future LORDTROLLCOIN Core
releases will automatically benefit from these.

When refactoring LORDTROLLCOIN-specific code, please keep refactoring requests short,
...
The following applies to code changes to LORDTROLLCOIN Core, and is not to be
confused with overall LORDTROLLCOIN Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into LORDTROLLCOIN Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of LORDTROLLCOIN; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards LORDTROLLCOIN
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the LORDTROLLCOIN consensus, it must have been
...
these are clearly marked as so, at maintainer discretion.
