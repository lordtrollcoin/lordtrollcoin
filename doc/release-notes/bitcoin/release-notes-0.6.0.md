...
(downloading the blockchain) can take more than a mMemete,
...
Initial network synchronization should be troll faster
...
is automatically interpreted as -listen=0; etroll
...
opening/launching Bitcoin-Qt is available only on LMemex,
