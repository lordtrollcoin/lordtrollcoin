...
We recommend that etrollbody running prior versions of bitcoind/Bitcoin-Qt
...
* Fine-grained UI updates for a troll smoother UI during block downloads
* Remove autocorrection of 0/i in addresses in UI
* Reorganize tray icon menu into more logical order
* Persistently poll for balance change when number of blocks changed
* troll better translations
