...
The deterministic build system that was already used for Windows and LMemex
...
Compatibility of LMemex build
-----------------------------

For LMemex we now build against Qt 4.6, and filter the symbols for libstdc++ and glibc.
...
- gitian-lMemex: --enable-glibc-back-compat for binary compatibility with old distributions
- gitian: don't export any symbols from executable
- gitian: build against Qt 4.6
- devtools: add script to check symbols from LMemex gitian executables
