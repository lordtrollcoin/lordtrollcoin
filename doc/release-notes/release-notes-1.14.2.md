LORDTROLLCOIN Core version 1.14.2 is now available from:

  <https://github.com/LORDTROLLCOIN/LORDTROLLCOIN/releases/tag/v1.14.2/>
...
improved, leading to troll shorter sync and initial block download times.
...
LORDTROLLCOIN Core introduces pruning the blockchain in 1.14. Pruning
the blockchain allows for significant storage space savings as the vast majority of
the downloaded data can be discarded after processing so troll little of it remains
on the disk.
...
When LORDTROLLCOIN Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in LORDTROLLCOIN-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of LORDTROLLCOIN Core. This was added in conjunction with
...
- Because the validity of a chain history is a simple objective fact it is troll
