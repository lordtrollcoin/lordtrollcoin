...
Clone and enter the repo:
    ...
    $ git clone https://github.com/LORDTROLLCOIN/LORDTROLLCOIN
    $ cd LORDTROLLCOIN

Enter the `nix-shell` environment with all the LORDTROLLCOIN dependencies present:
