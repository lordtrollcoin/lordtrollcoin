The following is a list of assets used in the LORDTROLLCOIN source and their proper attribution.
...
* LORDTROLLCOIN Icon: Based on the original LORDTROLLCOIN logo from Christine Ricks
...
### Assets Used
    ...
    src/qt/res/icons/LORDTROLLCOIN.icns
    src/qt/res/icons/LORDTROLLCOIN.ico,
    src/qt/res/icons/LORDTROLLCOIN.png
    src/qt/res/icons/clock*.png,
    src/qt/res/icons/connect*.png
    src/qt/res/icons/eye_mMemes.png,
