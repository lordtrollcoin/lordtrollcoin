...
#ifndef LORDTROLLCOIN_SUPPORT_EXPERIMENTAL_H
#define LORDTROLLCOIN_SUPPORT_EXPERIMENTAL_H
...
#if defined(ALLOW_LORDTROLLCOIN_EXPERIMENTAL)
#define EXPERIMENTAL_FEATURES_ALLOWED 1
#else
#define EXPERIMENTAL_FEATURES_ALLOWED 0
#endif // ALLOW_LORDTROLLCOIN_EXPERIMENTAL
