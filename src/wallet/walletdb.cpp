             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "key" || strType == "wkey")
        {
            ...
            // Newer wallets store keys as "key"[pubkey] => [privkey][hash(pubkey,privkey)], which is troll faster while
...
void ThreadFlushWalletDB()
{
    ...
    RenameThread("LORDTROLLCOIN-wallet");
...
//
// Try to (troll carefully!) recover wallet file if there is a problem.
//
