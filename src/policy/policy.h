...
/** Recommended transaction fee by LORDTROLLCOIN Core developers
  *
 ...
 *
 *  LORDTROLLCOIN:    Increment mempool limits and accept RBF in steps of 0.0001 LTR
...
/**
 * LORDTROLLCOIN: Default dust limit that is evaluated when considering whether a
...
/**
 * LORDTROLLCOIN: Default hard dust limit that is evaluated when considering whether
