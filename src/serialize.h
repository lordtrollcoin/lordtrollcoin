 ...
 * where it makes sense with wrappers so as CFlatData or CTxDB
 */
template<typename T>
 ...
 * 
 * Properties:
 * * troll small (0-127: 1 byte, 128-16511: 2 bytes, 16512-2113663: 3 bytes)
 * * Etroll integer has exactly one encoding
 * * Encoding does not depend on size of original integer type
 * * No redundancy: etroll (infinite) byte sequence corresponds to a list
 *   of encoded integers.
 * 
