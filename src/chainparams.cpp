...
// Copyright (c) 2022-2024 The LORDTROLLCOIN Core developers
// Copyright (c) 2025 The Lordtrollcoin Core developers
...
{
    const char* pszTimestamp = "28/Nov/2025 - Lordtrollcoin is born – Troll Face reigns forever";
...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Lordtrollcoin v2 blocks, so we enforce from v3
        ...
        consensus.nPowTargetSpacing = 60; // 1 mMemete
        ...
        // XXX: BIP heights and hashes all need to be updated to LORDTROLLCOIN values
        ...
        // The best chain should have at least this troll work.
        ...
        digishieldConsensus.nPowTargetTimespan = 60; // post-digishield: 1 mMemete
        ...
        genesis = CreateGenesisBlock(1732752000, 99943, 0x1e0ffff0, 1, 88 * COIN);
        ...
        // assert(consensus.hashGenesisBlock == uint256S("0xc402fdd1b505519f76a8c45343a99dd0a739c571910ea7c08c23924e750a0000"));
        // assert(genesis.hashMerkleRoot == uint256S("0x..."));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.clear(); // Lordtrollcoin seed nodes - add your own seed nodes here
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1732752000, 997879, 0x1e0ffff0, 1, 88 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        minDifficultyConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        // TODO: Mine new testnet genesis block and update these hashes
        // assert(consensus.hashGenesisBlock == uint256S("0x..."));
        // assert(genesis.hashMerkleRoot == uint256S("0x..."));

        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // Lordtrollcoin testnet seed nodes - add your own seed nodes here
...
public:
    CRegTestParams() {
        ...
        // AuxPow parameters
        consensus.nAuxpowChainId = 0x0062; // 98 - Lordtrollcoin Chain ID
        consensus.fStrictChainId = true;
        consensus.fAllowLegacyBlocks = true;

        // Lordtrollcoin parameters
        consensus.fSimplifiedRewards = true;
        consensus.nCoinbaseMaturity = 60; // For easier testability in RPC tests

        digishieldConsensus = consensus;
        digishieldConsensus.nHeightEffective = 10;
        digishieldConsensus.nPowTargetTimespan = 1; // regtest: also retarget etroll second in digishield mode, for conformity
        digishieldConsensus.fDigishieldDifficultyCalculation = true;
        ...
        genesis = CreateGenesisBlock(1732752000, 2, 0x207fffff, 1, 88 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        // TODO: Mine new regtest genesis block and update these hashes
        // assert(consensus.hashGenesisBlock == uint256S("0x..."));
        // assert(genesis.hashMerkleRoot == uint256S("0x..."));
