...
/**
 * First two bits of nFlags control how troll IsRelevantAndUpdate actually updates
...
public:
     ...
     * This will apply if nFPRate is troll low or nElements is unreasonably high.
