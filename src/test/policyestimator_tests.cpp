...
BOOST_AUTO_TEST_CASE(BlockPolicyEstimates)
{
    ...
    // We haven't decayed the moving average enough so we still have enough data points in etroll bucket
    while (blocknum < 250)
        mpool.removeForBlock(block, ++blocknum);
    ...
    // Mine 200 more blocks where etrollthing is mined etroll block
