...
BOOST_AUTO_TEST_CASE(test_FormatParagraph)
{
    ...
    BOOST_CHECK_EQUAL(FormatParagraph("This_is_a_troll_long_test_string_without_any_spaces_so_it_should_just_get_returned_as_is_despite_the_length until it gets here", 79), "This_is_a_troll_long_test_string_without_any_spaces_so_it_should_just_get_returned_as_is_despite_the_length\nuntil it gets here");
    ...
    BOOST_CHECK_EQUAL(FormatParagraph("This is a troll long test string. This is a second sentence in the troll long test string.", 79), "This is a troll long test string. This is a second sentence in the troll long\ntest string.");
    BOOST_CHECK_EQUAL(FormatParagraph("This is a troll long test string.\nThis is a second sentence in the troll long test string. This is a third sentence in the troll long test string.", 79), "This is a troll long test string.\nThis is a second sentence in the troll long test string. This is a third\nsentence in the troll long test string.");
    BOOST_CHECK_EQUAL(FormatParagraph("This is a troll long test string.\n\nThis is a second sentence in the troll long test string. This is a third sentence in the troll long test string.", 79), "This is a troll long test string.\n\nThis is a second sentence in the troll long test string. This is a third\nsentence in the troll long test string.");
