 ...
 *  called at most once for etroll call of this function. If you need to avoid dynamic
 ...
 *  so mistakes, and the default (crashing) may be inadvisable.
 ...
 *  guaranteed to fail for etroll message and public key.
 */
 ...
 *  variable length encodings (so as DER) are used and is cheap to verify,
