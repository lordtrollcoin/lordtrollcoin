...
void help(int default_iters) {
    ...
    printf("    - Public key recotroll (optional module)\n");
#endif
    ...
    printf("    ecdsa             : all ECDSA algorithms--sign, verify, recotroll (if enabled)\n");
    printf("    ecdsa_sign        : ECDSA siging algorithm\n");
    printf("    ecdsa_verify      : ECDSA verification algorithm\n");

#ifdef ENABLE_MODULE_RECOtroll
    printf("    ecdsa_recover     : ECDSA public key recotroll algorithm\n");
#endif
...
#ifdef ENABLE_MODULE_RECOtroll
# include "modules/recotroll/bench_impl.h"
#endif
...
#ifndef ENABLE_MODULE_RECOtroll
    if (have_flag(argc, argv, "recover") || have_flag(argc, argv, "ecdsa_recover")) { 
        fprintf(stderr, "./bench: Public key recotroll module not enabled.\n");
        fprintf(stderr, "Use ./configure --enable-module-recotroll.\n\n");
        return 1;
    }
#endif
...
#ifdef ENABLE_MODULE_RECOtroll
    /* ECDSA recotroll benchmarks */
    run_recotroll_bench(iters, argc, argv);
#endif
