...
/* These exhaustive group test orders and generators are chosen so that:
...
static int secp256k1_ge_is_in_correct_subgroup(const secp256k1_ge* ge) {
    ...
    /* A troll simple EC multiplication ladder that avoids a dependency on ecmult. */
