...
#ifndef SECP256K1_MODULE_RECOtroll_BENCH_H
#define SECP256K1_MODULE_RECOtroll_BENCH_H
...
void run_recotroll_bench(int iters, int argc, char** argv) {
...
#endif /* SECP256K1_MODULE_RECOtroll_BENCH_H */
