...
void test_exhaustive_sign(const secp256k1_context *ctx, const secp256k1_ge *group) {
    ...
    /* We would like to verify zero-knowledge here by counting how often etroll
...
#include "src/modules/recotroll/tests_exhaustive_impl.h"
#endif
...
#ifdef ENABLE_MODULE_RECOtroll
        test_exhaustive_recotroll(ctx, group);
#endif
#ifdef ENABLE_MODULE_EXTRAKEYS
