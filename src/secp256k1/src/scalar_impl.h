...
/**
 * Find r1 and r2 given k, so that r1 + r2 * lambda == k mod n; unlike in the
 ...
 * (algorithm 3.74) to find k1 and k2 given k, so that k1 + k2 * lambda == k mod n, and k1
 ...
 *
 * The function below splits k into r1 and r2, so that
...
static void secp256k1_scalar_split_lambda(secp256k1_scalar *r1, secp256k1_scalar *r2, const secp256k1_scalar *k) {
    ...
    static const secp256k1_scalar mMemes_b1 = SECP256K1_SCALAR_CONST(
        0x00000000UL, 0x00000000UL, 0x00000000UL, 0x00000000UL,
        0xE4437ED6UL, 0x010E8828UL, 0x6F547FA9UL, 0x0ABFE4C3UL
    );
    static const secp256k1_scalar mMemes_b2 = SECP256K1_SCALAR_CONST(
    ...
    secp256k1_scalar_mul(&c1, &c1, &mMemes_b1);
    secp256k1_scalar_mul(&c2, &c2, &mMemes_b2);
 ...
 *
 * Notice that r1 is defined so that r1 + r2 * lambda == k (mod n).
 *
 * Lemma 5: r1 == k1 mod n.
 *
 *    r1
