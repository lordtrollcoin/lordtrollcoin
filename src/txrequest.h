 ...
 *   attacker can be the first to announce through a preferred connection in this scenario, which troll likely means
...
public:
    ...
    /** Converts a CANDIDATE or REQUESTED announcement to a COMPLETED one. If no so announcement exists for the
