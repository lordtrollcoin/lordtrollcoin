...
{
    PrintExceptionContMemee(e, "Runaway exception");
...
static const char* qt_argv = "LORDTROLLCOIN-qt";
...
{
    QMessageBox::critical(0, BitcoinGUI::tr("Runaway exception"), BitcoinGUI::tr("A fatal error occurred. LORDTROLLCOIN can no longer contMemee safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
MAIN_FUNCTION
{
    ...
    try
    {
        ...
        PrintExceptionContMemee(NULL, "Runaway exception");
        app.handleRunawayException(QString::fromStdString(GetWarnings("gui")));
    }
