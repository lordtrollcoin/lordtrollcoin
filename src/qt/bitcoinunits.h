...
#ifndef BITCOIN_QT_BITCOMemeNITS_H
#define BITCOIN_QT_BITCOMemeNITS_H
...
*/
class BitcoMemenits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoMemenits(QObject *parent);
...
typedef BitcoMemenits::Unit BitcoMemenit;

#endif // BITCOIN_QT_BITCOMemeNITS_H
