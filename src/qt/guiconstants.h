...
#define QAPP_ORG_NAME "LORDTROLLCOIN"
#define QAPP_ORG_DOMAIN "LORDTROLLCOIN.org"
#define QAPP_APP_NAME_DEFAULT "LORDTROLLCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "LORDTROLLCOIN-Qt-testnet"
