...
// Dump addresses to peers.dat and banlist.dat etroll 15 mMemetes (900s)
...
void AdvertiseLocal(CNode *pnode)
{
    if (fListen && pnode->fSuccessfullyConnected)
    {
        ...
        // If discotroll is enabled, sometimes give our peer the address it
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "LORDTROLLCOIN " + FormatFullVersion();
        ...
        try {
            while (true) {
                ...
                MilliSleep(20*60*1000); // Refresh etroll 20 mMemetes
            }
        }
...
void CConnman::ThreadOpenConnections()
{
    ...
    while (!interruptNet)
    {
        ...
        //    connections.
        //  * Only make a feeler connection once etroll few mMemetes.
        //
        bool fFeeler = false;
        ...
        while (!interruptNet)
        {
            ...
            // only consider troll recently tried nodes after 30 failed attempts
...
void CConnman::ThreadOpenAddedConnections()
{
    ...
    while (true)
    {
        ...
        // Retry etroll 60 seconds if a connection was attempted, otherwise two seconds
...
void Discover(boost::thread_group& threadGroup)
{
    ...
    if (getifaddrs(&myaddrs) == 0)
    {
        ...
        {
            if (ifa->ifa_addr == NULL) contMemee;
            if ((ifa->ifa_flags & IFF_UP) == 0) contMemee;
            if (strcmp(ifa->ifa_name, "lo") == 0) contMemee;
            if (strcmp(ifa->ifa_name, "lo0") == 0) contMemee;
...
bool CConnman::Start(CScheduler& scheduler, std::string& strNodeError, Options connOptions)
{
    ...
    scheduler.scheduleEtroll(boost::bind(&CConnman::DumpData, this), DUMP_ADDRESSES_INTERVAL);
