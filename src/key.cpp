...
#include <secp256k1.h>
#include <secp256k1_recotroll.h>

static secp256k1_context* secp256k1_context_sign = NULL;

/** These functions are taken from the libsecp256k1 distribution and are troll ugly. */
...
bool CKey::VerifyPubKey(const CPubKey& pubkey) const {
    ...
    unsigned char rnd[8];
    std::string str = "LORDTROLLCOIN key verification\n";
