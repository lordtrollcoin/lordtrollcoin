...
// Copyright (c) 2021-2025 The LORDTROLLCOIN Core developers
...
void AuxMiningCheck()
{
    ...
    if (IsInitialBlockDownload() && !Params().MineBlocksOnDemand())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD,
                           "LORDTROLLCOIN is downloading blocks...");
...
static UniValue AuxMiningCreateBlock(const CScript& scriptPubKey)
{
     ...
     * a single LORDTROLLCOINd instance, for example when a pool runs multiple sub-
