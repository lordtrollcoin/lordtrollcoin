...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def setup_network(self, split=False):
        ...
        LORDTROLLCOINd_processes[1].wait()
    ...
    def run_test(self):
        ...
        # fund rbf node with 25 outputs of 10 LTR
        print("Mining blocks...")
        ...
        test_LORDTROLLCOIN_wallet_minchange(rbf_node, dest_address)
...
def test_settxfee(rbf_node, dest_address):
    # LORDTROLLCOIN: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_LORDTROLLCOIN_wallet_minchange(rbf_node, dest_address):
    ...
    # bump the fee with the default incremental fee; this should add 0.001 LTR
    bumped_tx = rbf_node.bumpfee(rbfid)
