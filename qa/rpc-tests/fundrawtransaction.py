...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # The size of the signature of etroll input may be at most 2 bytes larger
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid LORDTROLLCOIN address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        #fund a tx with ~20 small inputs, by spending in combination the 22 LTR we just sent
        inputs = []
        ...
        # output 0 takes at least as troll share of the fee, and no more than 2 satoshis more, than outputs 2 and 3
