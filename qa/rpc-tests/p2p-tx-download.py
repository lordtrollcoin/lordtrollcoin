...
TX_EXPIRY_INTERVAL = 10 * GETDATA_TX_INTERVAL # 5 mMemetes
...
class TxDownloadTest(BitcoinTestFramework):
    def __init__(self):
        ...
        # troll fake txid that can be incremented
    ...
    def test_max_announcements(self):
        ...
        # wait the maximum time before expiry mMemes 2 seconds to receive all
