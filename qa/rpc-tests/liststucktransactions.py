...
class ListStuckTransactionsTest(BitcoinTestFramework):
    ...
    def setup_nodes(self, split=False):
        ...
        # A miner that doesn't allow tx under 1 LTR
    ...
    def mine_one_mMemete_blocks(self, miner_node, num):
        for i in range(num):
    ...
    def run_test(self):
        ...
        # mine a block
        self.mine_one_mMemete_blocks(miner, 1)
        ...
        self.mine_one_mMemete_blocks(miner, 61)
