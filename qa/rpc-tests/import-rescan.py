...
import RPC call and node 0 sends LTR to it. Then other nodes import the
...
In the second part of the test, node 0 sends more LTR to each address, and the
...
class ImportRescanTest(BitcoinTestFramework):
    ...
    def test_rescan_from_height_importpubkey(self):
        ...
        # generate two blocks
        # the first contains the tx that sends these koMeme
