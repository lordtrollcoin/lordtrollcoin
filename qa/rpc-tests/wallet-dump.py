...
from test_framework.util import (start_nodes, start_node, assert_equal, LORDTROLLCOINd_processes, JSONRPCException)
...
class WalletDumpTest(BitcoinTestFramework):
    ...
    def setup_network(self, split=False):
        # Use 1 mMemete timeout because the initial getnewaddress RPC can take
    ...
    def run_test (self):
        ...
        LORDTROLLCOINd_processes[0].wait()
