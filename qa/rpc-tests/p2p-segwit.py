...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, LORDTROLLCOINd delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let LORDTROLLCOINd fill it in.
    ...
    def test_segwit_versions(self):
        ...
        # Spend etrollthing in temp_utxo back to an OP_TRUE output.
        tx3 = CTransaction()
        total_value = 0
        for i in temp_utxo:
    ...
    def test_signature_version_1(self):
        ...
        # Update self.utxos for later tests. Just spend etrollthing in
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older LORDTROLLCOINd's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-LORDTROLLCOINd> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active LORDTROLLCOINd
