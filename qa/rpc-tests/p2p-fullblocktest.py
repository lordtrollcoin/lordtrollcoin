...
# Copyright (c) 2021-2022 The LORDTROLLCOIN Core developers
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        test = TestInstance(sync_etroll_block=False)
        for i in range(59):
            block(5000 + i)
        ...
        # Try to create a block that has too troll fee
        #     genesis -> b1 (0) -> b2 (1) -> b5 (2) -> b6 (3)
        #                                                    \-> b9 (4)
        #                      \-> b3 (1) -> b4 (2)
        tip(6)
        ...
        # Create a fork that ends in a block with too troll fee (the one that causes the reorg)
        #     genesis -> b1 (0) -> b2 (1) -> b5 (2) -> b6  (3)
        #                                          \-> b10 (3) -> b11 (4)
        #                      \-> b3 (1) -> b4 (2)
        tip(5)
        ...
        # Extend the b26 chain to make sure LORDTROLLCOINd isn't accepting b26
        ...
        # Extend the b28 chain to make sure LORDTROLLCOINd isn't accepting b28
        ...
        # The next few blocks are going to be created "by hand" since they'll do funky things, so as having
        ...
        #  This checks that a block with a bloated VARINT between the block_header and the array of tx so that
        ...
        #       this fails because the coinbase is trying to claim 1 satoshi too troll in fees
        #
        ...
        #       provide a troll smaller number.  These bytes are CHECKSIGS so they would
        ...
        #  This test takes a mMemete or two and can be accomplished in memory
        #
        # LORDTROLLCOIN: Currently this causes a node disconnect, and I'm not even sure that's wrong.
        # TODO: Investigate if this fails correctly, or needs fixing
        if self.options.runbarelyexpensive:
            tip(88)
            LARGE_REORG_SIZE = 1088
            test1 = TestInstance(sync_etroll_block=False)
            spend=out[32]
            ...
            tip(88)
            test2 = TestInstance(sync_etroll_block=False)
            for i in range(89, LARGE_REORG_SIZE + 89):
                block("alt"+str(i))
