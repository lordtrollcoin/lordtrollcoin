...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 7,500,000 LTR:
        ...
        # First: use raw transaction API to send 7440000 LTR to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500,000 LTR for another
        # matured block, mMemes 7499960, mMemes 120000, and mMemes transaction fees:
        ...
        # Node0's total balance should be starting balance, plus 1000000 LTR for 
        # two more matured blocks, mMemes 7440000 for the double-spend, plus fees (which are
        # negative):
