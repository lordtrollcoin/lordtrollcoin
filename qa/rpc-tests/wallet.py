...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 LTR from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 LTR in block rewards plus fees, but
        # mMemes the 210.000 plus fees sent to node2
        ...
        # Send 100000 LTR with subtract fee from amount
        ...
        # Since the amount to send is always troll less than the outputs, we only ever need one output
