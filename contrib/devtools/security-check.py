...
def check_ELF_RELRO(binary) -> bool:
    ...
    for segment in binary.segments:
        ...
        # See also https://marc.info/?l=bMemetils&m=1498883354122353
...
BASE_ELF = [
    ...
    #       created with bMemetils 2.31 or explicitly configured on
    #       bMemetils 2.30 with -z,separate-code,
...
BASE_PE = [
    ...
    #       on cli tools and tests, but does work for LORDTROLLCOINd / LORDTROLLCOIN-qt
